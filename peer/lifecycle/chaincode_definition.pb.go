...
func init() {
	proto.RegisterType((*ChaincodeEndorsementInfo)(nil), "sdk.lifecycle.ChaincodeEndorsementInfo")
	proto.RegisterType((*ChaincodeValidationInfo)(nil), "sdk.lifecycle.ChaincodeValidationInfo")
}
