...
func init() {
	proto.RegisterEnum("sdk.protos.ChaincodeMessage_Type", ChaincodeMessage_Type_name, ChaincodeMessage_Type_value)
	proto.RegisterType((*ChaincodeMessage)(nil), "sdk.protos.ChaincodeMessage")
	proto.RegisterType((*GetState)(nil), "sdk.protos.GetState")
	proto.RegisterType((*GetStateMetadata)(nil), "sdk.protos.GetStateMetadata")
	proto.RegisterType((*PutState)(nil), "sdk.protos.PutState")
	proto.RegisterType((*PutStateMetadata)(nil), "sdk.protos.PutStateMetadata")
	proto.RegisterType((*DelState)(nil), "sdk.protos.DelState")
	proto.RegisterType((*GetStateByRange)(nil), "sdk.protos.GetStateByRange")
	proto.RegisterType((*GetQueryResult)(nil), "sdk.protos.GetQueryResult")
	proto.RegisterType((*QueryMetadata)(nil), "sdk.protos.QueryMetadata")
	proto.RegisterType((*GetHistoryForKey)(nil), "sdk.protos.GetHistoryForKey")
	proto.RegisterType((*QueryStateNext)(nil), "sdk.protos.QueryStateNext")
	proto.RegisterType((*QueryStateClose)(nil), "sdk.protos.QueryStateClose")
	proto.RegisterType((*QueryResultBytes)(nil), "sdk.protos.QueryResultBytes")
	proto.RegisterType((*QueryResponse)(nil), "sdk.protos.QueryResponse")
	proto.RegisterType((*QueryResponseMetadata)(nil), "sdk.protos.QueryResponseMetadata")
	proto.RegisterType((*StateMetadata)(nil), "sdk.protos.StateMetadata")
	proto.RegisterType((*StateMetadataResult)(nil), "sdk.protos.StateMetadataResult")
}
