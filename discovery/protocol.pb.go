...
func init() {
	...
	proto.RegisterMapType((map[string]*msp.FabricMSPConfig)(nil), "sdk.discovery.ConfigResult.MspsEntry")
	proto.RegisterMapType((map[string]*Endpoints)(nil), "sdk.discovery.ConfigResult.OrderersEntry")
	...
	proto.RegisterMapType((map[string]*Peers)(nil), "sdk.discovery.PeerMembershipResult.PeersByOrgEntry")
	...
	proto.RegisterMapType((map[string]*Peers)(nil), "sdk.discovery.EndorsementDescriptor.EndorsersByGroupsEntry")
	proto.RegisterType((*Layout)(nil), "sdk.discovery.Layout")
	proto.RegisterMapType((map[string]uint32)(nil), "sdk.discovery.Layout.QuantitiesByGroupEntry")
